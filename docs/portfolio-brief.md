...
二期交付已整理为一份可直接讲解的[二期交付与问题复盘](phase2-delivery.md)，覆盖资料/Prompt 治理、角色与会话、反馈闭环、场景感知检索、公开截图以及问题处理思路。展示时以合成 Demo 证明产品体验，以私有 real-local 证据说明工程边界；真实制度正文、逐题问答和 Provider 原始输出不进入 GitHub。
